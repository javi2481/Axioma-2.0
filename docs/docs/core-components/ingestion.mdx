...
2. On the <Icon name="Library" aria-hidden="true"/> **Knowledge** or <Icon name="Settings2" aria-hidden="true"/> **Settings** page, click **Add Knowledge** to ingest files and folders from your connected cloud storage.

After triggering ingestion, the selected files are processed in the background through the **OpenSearch Ingestion** flow.
...
:::info
If you have a lot of files in cloud storage, be aware that synchronization can trigger a large number of ingestions.
This can take a long time to complete, and timeouts can occur.
...
On the <Icon name="Library" aria-hidden="true"/> **Knowledge** or <Icon name="Settings2" aria-hidden="true"/> **Settings** page, click <Icon name="Settings2" aria-hidden="true"/> **Sync** to synchronize your cloud storage and your OpenRAG knowledge base.
